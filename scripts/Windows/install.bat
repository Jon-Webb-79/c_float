...
set "FLOAT_INCLUDE_DIR=%ProgramFiles(x86)%\c_float\include"
set "FLOAT_LIB_DIR=%ProgramFiles(x86)%\c_float\lib"
...
call :install_file "..\..\c_float\c_float.h" "%FLOAT_INCLUDE_DIR%\c_float.h" "float header" "c_float.h"
call :install_file "..\..\c_float\c_float.c" "%FLOAT_LIB_DIR%\c_float.c" "float source" "c_float.c"
